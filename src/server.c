...
/* Global Variables */
char *Port	      = "9894";
// CHANGED MIMETYPES PATH -- change back for student machine
//char *MimeTypesPath   = "/Users/willdennen/mime/mime.types";
...
int main(int argc, char *argv[]) {
    ServerMode mode = SINGLE; // default for valgrind sake
